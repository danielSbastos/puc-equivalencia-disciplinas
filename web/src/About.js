  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose} backdrop='static'>
        ...
        <Modal.Body>
            Sistema desenvolvido por <a onClick="window.open('https://www.linkedin.com/in/daniel-schlickmann-bastos-717ba9141/', '_blank')" target="_blank" href="https://www.linkedin.com/in/daniel-schlickmann-bastos-717ba9141/">Daniel S. Bastos</a>, aluno de graduação da Ciência de Computação
